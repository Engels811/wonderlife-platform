  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <CreatorCard title="Stream Sync" desc="Sync Twitch / YouTube Live Data" />
        ...
        <CreatorCard title="Instagram Tools" desc="Reels, Posts, Insights, Scheduling" />
        <CreatorCard title="TikTok Tools" desc="Auto-Shorts, Trends, Analytics" />
        <CreatorCard title="Twitter / X Tools" desc="Posts, Auto-Export, Engagement Tracking" />
        <CreatorCard title="Kick Tools" desc="Stream Sync, Clips, Creator Insights" />
      </div>
    </div>
  );
}
